...
const NotFound = () => {
   return (
      <div className="flex flex-col justify-center mt-10 items-center gap-2">
         <h1 className="text-center text-xl font-medium text-zinc-100">Pagina não encontrada!</h1>
         ...
         <Link
            to="/"
            className="text-xs px-4 py-2 border border-zinc-700 text-zinc-500 hover:text-zinc-100 transition-all duration-100"
         >
